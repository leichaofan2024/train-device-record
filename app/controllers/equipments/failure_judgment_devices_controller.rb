class Equipments::FailureJudgmentDevicesController < ApplicationController
  def index
  ...
  def update
      ...
      redirect_to equipment_category_equipmnets_failure_judgment_device_path(@equipment_category, @failure_judgment_device)
  end
