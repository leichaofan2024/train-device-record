class Equipments::GisCupboardsController < ApplicationController
  def index
  ...
  def update
      ...
      redirect_to equipment_category_equipmnets_gis_cupboard_path(@equipment_category, @gis_cupboard)
  end
