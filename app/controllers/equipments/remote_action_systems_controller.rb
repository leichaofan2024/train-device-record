class Equipments::RemoteActionSystemsController < ApplicationController
  def index
  ...
  def update
      ...
      redirect_to equipment_category_equipmnets_remote_action_system_path(@equipment_category, @remote_action_system)
  end
