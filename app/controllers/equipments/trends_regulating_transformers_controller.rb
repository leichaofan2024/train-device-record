class TrendsRegulatingTransformersController < ApplicationController
  def index
  ...
  def update
    ...
    redirect_to equipment_category_trends_regulating_transformer_path(@equipment_category,@trends_regulating_transformer)
  end
