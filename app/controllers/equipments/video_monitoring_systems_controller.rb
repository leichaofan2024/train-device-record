class VideoMonitoringSystemsController < ApplicationController
    def index
    ...
    def update
        ...
        redirect_to equipment_category_video_monitoring_system_path(@equipment_category, @video_monitoring_system)
    end
