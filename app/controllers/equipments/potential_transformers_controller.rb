class PotentialTransformersController < ApplicationController
  def index
  ...
  def update
    ...
    redirect_to equipment_category_potential_transformer_path(@equipment_category,@potential_transformer)
  end
