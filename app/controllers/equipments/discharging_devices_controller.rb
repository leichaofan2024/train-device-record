class Equipments::DischargingDevicesController < ApplicationController
  def index
  ...
  def update
      ...
      redirect_to equipment_category_equipmnets_discharging_device_path(@equipment_category, @discharging_device)
  end
