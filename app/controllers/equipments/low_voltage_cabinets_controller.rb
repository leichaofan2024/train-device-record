class Equipments::LowVoltageCabinetsController < ApplicationController
  def index
  ...
  def update
      ...
      redirect_to equipment_category_equipmnets_low_voltage_cabinet_path(@equipment_category, @low_voltage_cabinet)
  end
